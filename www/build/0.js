...
LangTestPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-lang-test',template:/*ion-inline-start:"/Users/Zerododici/git/ionProject/src/pages/lang-test/lang-test.html"*/'<!--\n  Generated template for the LangTestPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n    <ion-navbar>\n        <ion-buttons start>\n            <button ion-button (click)="dismiss()">Close</button>\n        </ion-buttons>\n        <ion-title>langTest</ion-title>\n    </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n    <li *ngFor="let lang of languagesProvider.languages">\n        {{lang.nativeName}}\n    </li>\n    <div *ngIf="languagesProvider.languages.length<1">\n        <h1>\n            No languages found\n        </h1>\n    </div>\n</ion-content>'/*ion-inline-end:"/Users/Zerododici/git/ionProject/src/pages/lang-test/lang-test.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* ViewController */], __WEBPACK_IMPORTED_MODULE_2__providers_languages_languages_provider__["a" /* LanguagesProvider */]])
], LangTestPage);
